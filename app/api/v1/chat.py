...
from app.core.agent.agent import SUMMARY_PROMPT
...
async def upload_template(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"上传模板失败: {e}")
    ...
    try:
        ...
        async with daa_service.use_agent(session, request.model_id, create_if_non_exist=True) as agent:
            ...
            if request.template_id and request.template_id != "default":
                ...
                from app.core.agent.agent import format_conversation
