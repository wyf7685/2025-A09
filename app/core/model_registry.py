...
class ModelInfo(BaseModel):
    ...
    # 状态信息
    status: str = "trained"  # created, training, trained, failed
    version: str = "v1.0.0"
...
class ModelRegistry:
    ...
    def list_models(self, session_id: str | None = None) -> list[ModelInfo]:
        """列出所有模型"""
    ...
    def get_session_models(self, session_id: str) -> list[ModelInfo]:
        """获取会话的所有模型"""
