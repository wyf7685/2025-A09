...
<template>
  <div class="data-management-container">
    ...
    <DataSourceUploadPanel
      ...
      @openDatabaseDialog="openAddDatabase" />

    <!-- 搜索和过滤区域 -->
    <DataSourceSearchBar
      v-model:searchQuery="searchQuery"
      :selectedSources="selectedSources"
      :sourceNames="getDatasourceNameMap()"
      @createSession="createSessionWithSelectedSources" />
    ...
    <DataSourceTable
      ...
      @analyze="selectForAnalysis" />

    <!-- 编辑数据源对话框 -->
    <EditDataSourceDialog
      v-model:visible="editDialogVisible"
      :datasource="currentEditSource"
      @save="saveEdit" />
    ...
    <!-- 数据清洗对话框 -->
    <DataCleaningDialog
      v-model:visible="dataCleaningDialogVisible"
      v-model:step="cleaningStep"
      v-model:userRequirements="userRequirements"
      v-model:selectedModel="selectedModel"
      v-model:fileMetadata="fileMetadata"
      ...
      :selectedCleaningActions="selectedCleaningActions"
      :analysisResult="analysisResult"
      :availableModels="availableModels"
      @analyze="analyzeDataQualityWithAI"
      @skipAndUpload="skipCleaningAndUpload"
      @applyCleaningActions="applyCleaningActions"
      @complete="completeCleaningAndUpload"
      @close="closeCleaningDialog"
      @toggleCleaningAction="toggleCleaningAction" />

    <!-- 添加数据库对话框 -->
    <AddDatabaseDialog
      v-model:visible="addDatabaseDialogVisible"
      @success="onDatabaseAddSuccess" />
  </div>
</template>
