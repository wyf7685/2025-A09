...
import { Setting, ChatDotRound, EditPen, Document, Cpu } from '@element-plus/icons-vue';
import { ElButton, ElDialog, ElForm, ElFormItem, ElMessage, ElSelect, ElOption, ElIcon, ElCard } from 'element-plus';
                    ...
                    <el-card v-for="config in nodeConfigs" :key="config.key" class="config-card"
                        ...
                        <el-form-item class="model-selector">
                            <el-select v-model="formData[config.key]" placeholder="选择模型" filterable
                                :clearable="config.key !== 'default'" size="large">
