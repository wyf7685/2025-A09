  ...
  <div class="dashboard">
    ...
    <div class="analysis-card quick-actions-card">
      ...
      <el-row :gutter="20" class="actions-row">
        <el-col :span="6">
          <div 
            class="quick-action-card upload-card" 
        ...
        <el-col :span="6">
          <div 
            class="quick-action-card sources-card" 
        ...
        <el-col :span="6">
          <div 
            class="quick-action-card chat-card" 
            @click="$router.push('/chat-analysis')"
          >
        ...
        <el-col :span="6">
          <div 
            class="quick-action-card analysis-card-action" 
            @click="$router.push('/auto-analysis')"
          >
      ...
      <div class="dataset-overview">
        <el-descriptions :column="3" border>
          ...
          <el-descriptions-item label="数据行数">
            {{ currentDataset.shape ? currentDataset.shape[0] : 0 }}
          </el-descriptions-item>
          <el-descriptions-item label="数据列数">
            {{ currentDataset.shape ? currentDataset.shape[1] : 0 }}
          </el-descriptions-item>
          <el-descriptions-item label="上传时间">
            {{ formatDate(currentDataset.loaded_at) }}
          </el-descriptions-item>
        </el-descriptions>
      </div>
    </div>
  ...
  try {
    ...
    if (session) {
      ...
      if (session.current_dataset) {
        ...
        currentDataset.value = datasets.value.find(d => d.id === session.current_dataset)
      }
    }
  } catch (error) {
