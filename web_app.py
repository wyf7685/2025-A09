...
def chat_analysis():
    ...
    try:
        ...
        if session_id not in agents:
            ...
            llm = limiter | get_llm()
            agents[session_id] = DataAnalyzerAgent(
                df, llm, get_chat_model(), pre_model_hook=limiter
            )
...
def index():
    ...
    <body>
        ...
        <div class="status">
            ...
            <div class="status-item">
                <span>活跃会话</span>
                <span id="session-count">""" + str(len(sessions)) + """</span>
            </div>
            <div class="status-item">
                <span>数据集</span>
                <span id="dataset-count">""" + str(len(datasets)) + """</span>
            </div>
        </div>
